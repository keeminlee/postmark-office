...
// than loosened to a `>=`.
test("THE COMMONS' READS: eighteen (thirteen + the three lanes + the quarter + marks), and each one SERVES a flat verb rather than reimplementing it", async () => {
  ...
  // (lane E item 2, the walk's "what has Errant put in the world?").
